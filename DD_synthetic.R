...
original.data <- Read10X(data.dir = paste0("/scratch/antwerpen/206/vsc20688/master_thesis/leishmania/diploid/dataset_5/synthetic_",
                                           method,
                                           "/",
                                           percentage,
                                           "percent/",
...
Main_Doublet_Decon(rawDataFile = newFiles_original$newExpressionFile,
                   ...
                   "original",
                   location = paste0("/scratch/antwerpen/206/vsc20688/master_thesis/leishmania/diploid/dataset_5/synthetic_",
                                     method,
                                     "/",
                                     percentage,
                                     "percent/",
